...
class EditorAPI(NessusEndpoint):
    ...
    def audits(self, type, object_id, file_id, fobj=None):
        '''
        Retrieves an audit file from Nessus
        ...
        resp = self._api.get(
            'editor/{}/{}/audits/{}'.format(
                self._check('type', type, str, choices=['scan', 'policy']),
    ...
    def details(self, type, template_uuid):
        ...
        return self._api.get(
            'editor/{}/templates/{}'.format(
                self._check('type', type, str, choices=['scan', 'policy']),
                self._check('template_uuid', template_uuid, str)
            )).json()
